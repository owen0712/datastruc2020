    ...
    public class JumpyGrof extends JPanel implements ActionListener{
        ...
        public static void main(String[]args) throws Exception {
            ...
            if(x==0){//consoleinput option
                consoleinput();
                logger.info("\nUser select to input at console");
            }
            else{//GUI option
                GUI.start();
                logger.info("\nUser select to  input at GUI");  
            }
        }
        ...
        public static void run(){
            ...
            logger.addHandler(fh);
                ...
                logger.warning("File logger not working.");
            }                
            ...
            while(true){
                colonized=0;
                int kangaroos=kangaroo.size();//reset size of kangaroo
                logger.info("\nKangaroos is preparing to move");
                for(int i=0;i<kangaroo.size();i++){
                    //number of knagaroo descrease if they cannot move due to following situation
                ...
                if(kangaroos==0)//if no kangaroo can move
                    break;
            }
            //log details for the result
            LinkedList<Point>colonies=map.getColonies();
            String detail="\nNumber of colonies:"+colonies.size();
            for(int i=0;i<colonies.size();i++)
                detail+="\nPoint "+colonies.get(i).getID()+" : "+colonies.get(i).getKangaroo().size();
        ...
        public static void input(){
            ...
            logger.info("\nUser key in input manually");
        }

        public static void random(){
            logger.info("\nRandom input is generated by system");
            Random r=new Random();
        ...
        public JumpyGrof(){
            logger.info("\nKangaroo simulation started");
            //set the Jframe property
            ...
            frame.setTitle("JumpyGrof");
            //Timer is used to refresh the frame for animation
